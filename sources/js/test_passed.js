...
layui.use(['laypage', 'layer', 'table', 'form', 'laydate'], function () {
  ...
  $('#inboundAllBt').on('click', function () {                                  //...全部入库 按钮...//
    var data = form.val("inboundAllInfo")
    if (data.selectDNinpt == "") {
      ...
      // $.each(table_data,function(index,elem){
  ...
  table.on('checkbox(test)', function (obj) {                          //...复选框发生改变...//
    ...
    if (inbound_meterID.length > 0) {
      ...
      $('#inboundBt').on('click', function () {                                  //...入库 按钮...//
        ...
        if (data.selectDNinpt_2 == "") {
          $('#selectDNdiv_2').addClass('warnBorder')
          $('#selectValveDiv_2').removeClass('warnBorder')
          $('#memoDiv_2').removeClass('warnBorder')
        }
        else if (data.selectValveInpt_2 == "") {
          $('#selectValveDiv_2').addClass('warnBorder')
          $('#memoDiv_2').removeClass('warnBorder')
          $('#selectDNdiv_2').removeClass('warnBorder')
        }
        else if (data.memoInpt_2 == "") {
          $('#memoDiv_2').addClass('warnBorder')
          $('#selectDNdiv_2').removeClass('warnBorder')
          $('#selectValveDiv_2').removeClass('warnBorder')
        }
        else {
          ...
          $.ajax({
            ...
            , data: {
              ...
              , 'scale': 0
              , "extra": {
                "dn": data.selectDNinpt_2
                , "isValve": data.selectValveInpt_2
                , "mark": data.memoInpt_2
              }
              , "import": true
              , "inbound": "入库"
              , inbound_meterID
