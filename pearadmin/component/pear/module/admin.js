layui.define(['message', 'table', 'jquery', 'element', 'yaml', 'form', 'tab', 'menu', 'frame', 'theme', 'convert', 'fullscreen'],
	function (exports) {
		...
		var pearAdmin = new function () {
			...
			this.setMenuWhereData = function (whereData) {  // 后加
				menuWhereData = whereData
			}
			...
			this.menuRender = function (param) {
				sideMenu = pearMenu.render({
					...
					url: param.menu.url,    //  后改
					data: menuWhereData,    //  后改
					parseData: false,
					change: function () {
						compatible();
					},
		...
		function collapse() {
			...
			if (admin.is(".pear-mini")) {
				...
				pname.css("color", "#28333E")
				manConsole.css("color", "#28333E")
